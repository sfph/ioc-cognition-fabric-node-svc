...
`ioc-cognition-fabric-node-svc` project.
...
The `ioc-cognition-fabric-node-svc` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ioc-cognition-fabric-node-svc`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ioc-cognition-fabric-node-svc` leverages GitHub's private vulnerability reporting.
